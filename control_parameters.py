...
def print_coefficients():
    print("\nRoll Kp: ", roll_kp)
    print("Roll Kd: ", roll_kd)
    print("\nCourse Kp: ", course_kp)
    print("Course Ki: ", course_ki)
    print("\nPitch Kp: ", pitch_kp)
    print("Pitch Kd: ", pitch_kd)
    print("\nAltitude Kp: ", altitude_kp)
    print("Altitude Ki: ", altitude_ki)
    print("\nAirspeed Kp: ", airspeed_throttle_kp)
    print("Airspeed Ki: ", airspeed_throttle_ki)
